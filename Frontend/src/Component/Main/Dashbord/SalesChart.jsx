...
const SalesChart = () => {
  ...
  return (
    <Card style={{backgroundColor:'transparent',color:"white",backdropFilter: "blur(1500px)"}} className="border">
      <CardBody >
        ...
        <Chart options={options} series={series} type="area" height="279"  style={{backgroundColor:'transparent',color:"red"}}/>
      </CardBody>
    </Card>
  );
};
