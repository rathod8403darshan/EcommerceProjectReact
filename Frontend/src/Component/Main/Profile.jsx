  ...
  return (
     ...
     <>
          <div className='w-100 text-center ms-2'>
             <h5 className='text-light fw-bold' style={{letterSpacing:"1px"}}>Profile  </h5>
          </div>
                    ...
                    <div className="card">
                      <div className="card-body">
                        <div className="d-flex flex-column align-items-center text-center">
                          <img src={x.userImage} alt="Admin" className="rounded-circle" width="150" height={"150"}/>
                          <div className="mt-3">
                            <h4>John Doe</h4>
...
export default HocMainCompo(Profile)